        ...
        <div class="col-md-4 col-md-offset-4">
            <div class="panel panel-default">
                <div class="panel-body" align="center">
                    <img src="/account/foto/{{$pegawai->photo}}" width="100" height="100">
                </div>
            </div>
        </div>
    </div>
    		...
    		<div class="panel panel-default">
    			...
    			<div class="panel-body">
	    			<table class="table table-hover">
    					...
    					<tr>
    						<td>Uang Lembur <br>{{$pegawai->jabatan->nama_jabatan}} _ {{$pegawai->golongan->nama_golongan}}</td>
    						<td>
    						<div class="input-group">
    							<span class="input-group-addon">Rp.</span>
    							
								{!! Form::label('Bayaran Lembur','Bayaran Lembur',['class'=>'form-control','id'=>'appendprepend']) !!}
								<span class="input-group-addon">.00</span>
							</div>
    						</td>
    					</tr>
