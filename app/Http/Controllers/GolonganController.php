...
class GolonganController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        $nama_golongan = golongan::all()->where('nama_golongan',$golongan['nama_golongan'])->first();
        $uang_golongan = golongan::all()->where('besaran_uang',$golongan['besaran_uang'])->first();
        ...
        if(isset($nama_golongan))
        {
                if (isset($uang_golongan)) 
                {
            $sms=['besaran_uang.unique'=>'Besaran Uang Sudah ada '.$uang_golongan->kode_golongan,
                'kode_golongan.required'=>'Harus Di Isi',
                'kode_golongan.unique'=>'Kode Sudah Ada',
                'nama_golongan.unique'=> 'Nama Golongan Sudah Ada di '.$nama_golongan->kode_golongan,
        ...
        elseif(isset($uang_golongan))
        {
            $sms=['kode_golongan.required'=>'Harus Di Isi',
                'kode_golongan.unique'=>'Kode Sudah Ada',
                'besaran_uang.unique'=>'Besaran Uang Sudah ada '.$uang_golongan->kode_golongan,
                'nama_golongan.required'=>'Harus Di Isi',
                'besaran_uang.required'=>'Harus Diisi',
                'besaran_uang.numeric'=>'Harus Angka'];
        }
