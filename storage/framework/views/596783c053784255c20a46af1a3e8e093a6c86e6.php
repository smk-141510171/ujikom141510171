	...
	<div class="panel panel-default">
		<div class="panel-heading">Tambah Tunjangan</div>
			<div class="panel-body">
				<form class="form-horizontal" action="<?php echo e(route('tunjanganpegawai.update',$tunjangan_pegawai->id)); ?>" method="POST">
                    <div class="form-group<?php echo e($errors->has('pegawai_id') ? ' has-error' : ''); ?>">
                            ...
                            <div style="width: 100%;color: red;text-align: center;">
                                Pegawai ini tidak memiliki Tunjangan, silahkan untuk membuat kategori <a href="<?php echo e(url('tunjangan/create')); ?>">disini</a>
                            </div>
                            <?php endif; ?>
                                </div>
                    </div>
