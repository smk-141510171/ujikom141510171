        ...
        <div class="col-md-4 col-md-offset-4">
            <div class="panel panel-default">
                <div class="panel-body" align="center">
                    <img src="/account/foto/<?php echo e($pegawai->photo); ?>" width="100" height="100">
                </div>
            </div>
        </div>
    </div>
    		...
    		<div class="panel panel-default">
    			...
    			<div class="panel-body">
	    			<table class="table table-hover">
    					...
    					<tr>
    						<td>Uang Lembur <br><?php echo e($pegawai->jabatan->nama_jabatan); ?> _ <?php echo e($pegawai->golongan->nama_golongan); ?></td>
    						<td>
    						<div class="input-group">
    							<span class="input-group-addon">Rp.</span>
    							
								<?php echo Form::label('Bayaran Lembur','Bayaran Lembur',['class'=>'form-control','id'=>'appendprepend']); ?>
