		...
		<div class="panel-heading" style="background-color: lightblue"><b><?php echo e($page); ?></b></div>
			<div class="panel-body">
				<form class="form-horizontal" action="<?php echo e(route('tunjangan.store')); ?>" method="POST">	
                    ...
                    <?php if(isset($error_create)): ?>
                            <div style="width: 100%;color: red;text-align: center;">
                                Untuk Tunjangan Yang Jabatan <u><?php echo e($tunjangan1->jabatan->nama_jabatan); ?></u> && Golongan <u><?php echo e($tunjangan1->golongan->nama_golongan); ?></u> Status <u><?php echo e($tunjangan1->status); ?></u> Jumlah Anak <u><?php echo e($tunjangan1->jumlah_anak); ?></u> Sudah Ada 
                            </div>
                            <?php endif; ?>
                    </div>
					<div class="form-group">
